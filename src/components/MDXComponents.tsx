...
export const MDXComponents = {
  ...
  img: function Img({
    ...
    return (
      <div
        className={clsx(
          'group isolate my-10 overflow-hidden rounded-4xl bg-neutral-100 dark:bg-neutral-900 max-sm:-mx-6',
          className,
        )}
      >
  ...
  TopTip({
    ...
    return (
      <Border position="left" className={clsx('my-10 pl-8', className)}>
        <p className="font-display text-sm font-bold uppercase tracking-widest text-neutral-950 dark:text-white">
          Top tip
        </p>
